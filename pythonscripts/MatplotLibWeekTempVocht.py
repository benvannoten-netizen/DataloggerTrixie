...
# Haal temperatuur data op - 672 laatste metingen = WEEK  (96 / dag)
query_temp = """
...
# set title
plt.title("Temperatuur & Vochtigheid laatste week " + "Raspi21 " + vandaag)
...
# plt.show()
plt.savefig('/var/www/html/Raspi21WeekTempVocht.png', dpi=100)
