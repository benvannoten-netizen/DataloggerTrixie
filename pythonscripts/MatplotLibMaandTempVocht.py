...
# Haal temperatuur data op - 2688 laatste metingen = MAAND  (96 / dag * 28 dagen)
query_temp = """
...
# set title
plt.title("Temperatuur & Vochtigheid laatste maand " + "Raspi21 " + vandaag)
...
# plt.show()
plt.savefig('/var/www/html/Raspi21MaandTempVocht.png', dpi=100)
